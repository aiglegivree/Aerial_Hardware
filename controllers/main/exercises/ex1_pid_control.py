...
class quadrotor_controller():
    def __init__(self, exp_num):
        ...
        gains = {
                    "P_pos_z": 1.2,     "I_pos_z": 0.0,     "D_pos_z": 0.2,
                    "P_pos_xy": 2.0,    "I_pos_xy": 0.0025,    "D_pos_xy": 0.3,
                    "P_vel_z": 10.0,     "I_vel_z": 0.23,     "D_vel_z": 2.75,
                    "P_vel_xy": 0.2,    "I_vel_xy": 0.025,    "D_vel_xy": 0.0,
    ...
    def setpoint_to_pwm(self, dt, setpoint, sensor_data):
        ...
        # Calculate rotation
        quat = [sensor_data["q_x"], sensor_data["q_y"],sensor_data["q_z"],sensor_data["q_w"]]
